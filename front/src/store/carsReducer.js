  ...
  switch (action.type) {
    ...
    //   return {...state, cars: action.payload};
      ...
      case ACTypes.BRAND_FILTER:      
        ...
        return {...state, filter:true, filteredCars: filteredCars};
      ...
      return {...state, filter:true, filteredCars: filteredByBody};
      ...
      return {...state, filter:true, filteredCars: filteredByClass};
      ...
      case ACTypes.PRICE_FILTER:      
        ...
        if (price==="по возрастанию")  {
          ...
          return {...state, filter:true, filteredCars: filteredByPrice }
        } else {
